...
import { Search, LayoutDashboard, Table, ChartSpline, BookType, SquarePen, Mail, Files} from "lucide-react";
        ...
        {showSidebar && (
          <Sidebar>
            ...
            <SidebarBody>
              ...
              <SidebarItem label="Documents" icon={<File className="w-5 h-5" />} />

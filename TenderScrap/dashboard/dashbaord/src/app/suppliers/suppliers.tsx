...
const SuppliersDatabase = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/tenders/suppliers")
      .then((res) => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">SUPPLIER DATABASE</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card
          ...
          footer="Immidiate Reach Out"
          link="supliers/"
        />
        <Card
          color="blue"
          title="Within Africa"
          subtitle="Suppliers in Africa"
          footer="Only in africa"
          link="/continental"
        />
        <Card
          color="yellow" 
...
export default SuppliersDatabase;

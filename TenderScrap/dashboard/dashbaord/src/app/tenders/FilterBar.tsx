          ...
          <div className="flex items-center space-x-3 w-full md:w-auto">
            ...
            <div className="relative inline-block text-left w-full md:w-auto">
              ...
              {showDropdown && (
                ...
                >
                  <h6 className="mb-3 text-sm font-medium text-white dark:text-white bg-green- p-2 bg-green-500 rounded-lg border hover:bg-green-900 hover:text-primary-700">
                    Date Collected
                  </h6>
